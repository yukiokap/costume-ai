...
export const EditorProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    const [selectedPoseStance, setSelectedPoseStance] = useState('random');
    const [poseDescription, setPoseDescription] = useState('');
    const [selectedExpression, setSelectedExpression] = useState('random');
    ...
    const [selectedShotAngle, setSelectedShotAngle] = useState<string>('random');
    ...
    const resetEditor = useCallback(() => {
        ...
        setSelectedShotType('random');
        setSelectedShotAngle('random');
