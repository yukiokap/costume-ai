...
export const translations = {
    ja: {
        ...
        editor: {
            ...
            shot_type_label: '被写体の距離',
            shot_angle_label: 'カメラアングル',
            shot_type_presets: {
                random: 'おまかせ',
                full_body: '全身',
                cowboy_shot: '膝上',
        ...
        results: {
            ...
            tour: {
                ...
                step_sample_title: 'サンプルビジュアル',
                step_sample_desc: '「目」のアイコンから、視覚的にパラメータを選べるサンプルギャラリーを開けます。',
    ...
    en: {
        ...
        results: {
            ...
            tour: {
                ...
                step3_desc: 'Fine-tune Sexy Level and Jewel Level individually to achieve your ideal output.',
                step_sample_title: 'Sample Visuals',
                step_sample_desc: 'Tap the "Eye" icon to open a gallery where you can intuitively choose settings from visual samples.',
                step4_title: 'OVERDRIVE (R18)',
